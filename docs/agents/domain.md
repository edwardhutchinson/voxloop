...
If voxloop later splits into genuinely separate contexts, switch to a root `CONTEXT-MAP.md` pointing at one `CONTEXT.md` per context (with `src/<context>/docs/adr/` for context-scoped decisions) and update this file.
